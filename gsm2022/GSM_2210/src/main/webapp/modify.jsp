...
<body>
	...
	String orderno= request.getParameter("key");
	try{
	...
	<tr>
		...
		<td>
			...
			<input type="radio" name="drink" value="10005" <%if(rs.getString(4).equals("10005")) out.println("checked"); %>>콜드 부르
		</td>
	</tr>
	<tr>
		<td>수량</td>
	...
	<tr> 
		<td>주문일자</td>
		<td><input type="text" name="date" placeholder="예) 20220105" value="<%=rs.getDate(6) %>"></td>
	</tr>
	<tr>
