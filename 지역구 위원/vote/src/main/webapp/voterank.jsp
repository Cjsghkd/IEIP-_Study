			...
			<h2 style="text-align: center">후보자등수</h2>
				<form style="display: flex; align-content: center; justify-content: center; text-align: center">
					<table border="1">
						...
						<%
							String sql = "select me.M_NO, me.M_NAME, count(vo.M_NO) from TBL_VOTE_2020 vo, TBL_MEMBER_2020 me where vo.M_NO = me.M_NO group by me.M_NO, me.M_NAME order by count(vo.M_NO) desc";
