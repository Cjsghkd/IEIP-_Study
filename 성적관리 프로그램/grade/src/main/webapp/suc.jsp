...
<%
String subcodecheck = request.getParameter("subcode");
%>
<jsp:include page="header.jsp"></jsp:include>
	...
	<section style="position: fixed; top: 80px; left: 0px; width: 100%; height: 100%; background-color: lightgray">
		<h2 style="text-align: center">과목별 성적조회</h2>
			...
			<form style="display: flex; align-content: center; justify-content: center; text-align: center; margin-top: 30px">
				<table border="1">
					<tr>
						<td>학번</td>
						<td>성명</td>
					...
					<%
					String sql = "select st.stuid, st.sname, su.subname, sc.subcode, su.proname, sc.midscore, sc.finalscore, sc.attend, sc.report, sc.etc from TBL_STUDENT_202210 st, TBL_SCORE_202210 sc, TBL_SUBJECT_202210 su where st.stuid = sc.sid AND sc.subcode = su.subcode AND sc.subcode = ? order by st.sname";
					PreparedStatement pstmt = con.prepareStatement(sql);
					pstmt.setString(1, subcodecheck);
